    ...
    <div class="w-2/4 mx-auto">
        <form @submit.prevent="submit">
            <div class="grid place-items-center">
                ...
                <img class="object-cover w-28 h-28" :src="form.preview ?? 'storage/avatars/l7GRVBCuPbU4lRqUgvQ1Hjt9LNinTXqZBtSl7Z3h.png'"/>
                </div>
            ...
            <TextInput name="confirmation password" type="password" v-model="form.password_confirmation" />
